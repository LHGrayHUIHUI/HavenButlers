...
public final class ThreadPoolUtils {
    ...
    public static ExecutorService createDefaultThreadPool(String name) {
        return createCustomThreadPool(
            name,
            SystemConstants.ThreadPool.CORE_POOL_SIZE,
            SystemConstants.ThreadPool.MAX_POOL_SIZE,
            SystemConstants.ThreadPool.KEEP_ALIVE_SECONDS,
            TimeUnit.SECONDS,
            SystemConstants.ThreadPool.QUEUE_CAPACITY
        );
    }
