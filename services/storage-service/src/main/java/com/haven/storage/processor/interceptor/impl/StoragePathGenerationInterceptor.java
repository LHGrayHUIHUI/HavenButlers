...
import com.haven.storage.strategy.storage.factory.StorageNamingStrategyFactory;
...
public class StoragePathGenerationInterceptor implements FileProcessInterceptor {
     ...
     * @param context
     * @return
     * @see StorageNamingStrategy
     */
    private FileStorageInfo createFileStorageInfo(FileProcessContext context) {
        StorageNamingStrategy strategy = StorageNamingStrategyFactory.getStrategy(context.getStorageType());
